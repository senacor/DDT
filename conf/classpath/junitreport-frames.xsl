...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    xmlns:stringutils="xalan://or.apache.tools.ant.util.StringUtils"
...
<!-- ======================================================================
  ...
  <xsl:template match="testsuite" mode="class.details">
    ...
    <html>
      <head>
        <title>Unit Test Results: <xsl:value-of select="$class.name"/>
        </title>
        ...
        function toggleAllDetails() {
          var divs = document.getElementsByName("errordetails");
          var newDisplayValue;
          if (document._testframeworkErrorDetailsShown) {
            document._testframeworkErrorDetailsShown = false;
            newDisplayValue = "none";
          } else {
            document._testframeworkErrorDetailsShown = true;
      ...
      <body>
        ...
        <h3>Class <xsl:value-of select="$class.name"/>
        </h3>
...
<!-- list of classes in a package -->
  <xsl:template name="classes.list">
    ...
    <html>
      <head>
        <title>Unit Test Classes: <xsl:value-of select="$name"/>
        </title>
        <xsl:call-template name="create.stylesheet.link">
  ...
  <xsl:template name="package.summary">
    ...
    <html>
      ...
      <body>
        ...
        <xsl:call-template name="pageHeader"/>
        <h3>Package <xsl:value-of select="$name"/>
        </h3>
...
<!-- method header -->
  <xsl:template name="testcase.test.header">
    ...
    <xsl:if test="./testcase/error|./testcase/failure">
      <tr>
        <td align="right" colspan="5"><a href="javascript:toggleAllDetails();">Toggle all Details</a></td>
      </tr>
    </xsl:if>
  </xsl:template>
        ...
        <xsl:choose>
          <xsl:when test="failure">
            <a class="errordetails">
              <xsl:attribute name="href">javascript:toggle('errordetails<xsl:value-of select="@test-id"/>');</xsl:attribute>
              Details &#187;
            </a>
            <div name="errordetails" class="errordetails">
              <xsl:attribute name="id">errordetails<xsl:value-of select="@test-id"/></xsl:attribute>
